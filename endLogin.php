...
<div class="app-container" style="padding: 24px;">
    ...
    <div class="actions-box">
        ...
        <div class="action-card">
            ...
            <a href='settings'><button class="btn btn-primary" style='margin-top: 8px;'>
        ...
        <div class="action-card">
            ...
            <button class="btn btn-primary" style='margin-top: 8px;' onclick="Notification.requestPermission()">
                <div style="display: grid; grid-template-columns: 16% 87%;">
        ...
        <div class="action-card">
            ...
            <a href='home'><button class="btn btn-primary" style='margin-top: 8px;'>
                <div style="display: grid; grid-template-columns: 16% 87%;">
