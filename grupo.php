...
<div class="app-container">
    ...
    <header class="app-header">
        ...
        <span class="app-title">Grupo</span>
    ...
    <div class="feed">
        ...
        <div style="display:flex; flex-direction:column; align-items:center; gap:12px;">
            <div class="user-mini-info">
                <div class="avatar" style="width:90px; height:90px; background: url(<?= htmlspecialchars($grupo['imagemUrl'] ?? '') ?>); background-repeat: no-repeat; background-size: cover;"></div>
                <span>
                    <strong><?= htmlspecialchars($grupo['nome']) ?></strong><br>
            ...
            <div class="profile-tabs">
                ...
                <button class="icon-btn" style="padding: 8px;" onclick="switchTab('about')"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="M440-280h80v-240h-80v240Zm68.5-331.5Q520-623 520-640t-11.5-28.5Q497-680 480-680t-28.5 11.5Q440-657 440-640t11.5 28.5Q463-600 480-600t28.5-11.5ZM480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z"/></svg></button>
            </div>
        </div>
